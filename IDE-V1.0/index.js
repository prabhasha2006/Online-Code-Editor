...
<body>
  ...
  <h1 id="Myhead" class="reddragon">SImple Online IDE</h1>
  <p id="Mypara" class="reddragon">Powered By RED DRAGON</p>
...
var txt_color = document.getElementById('txtcolor')
...
var html_bg = document.getElementById('html_ide')
...
function timecolor() {
  ...
  aud.play()
  let clock = document.getElementById('times')
  const colourlibrary = ['black','red','rgb(9, 255, 0)','rgb(0, 0, 255)','rgb(196, 40, 255)','pink','rgb(169, 255, 88)','yellow','orange','rgb(255, 228, 228)']
// * changing 10 colors
...
// * mobile screen fix
if (screen.width <= 840) {
  document.getElementById('headline_a').innerHTML = "IDE"
  document.getElementById('headline_b').innerHTML = "RUN"
